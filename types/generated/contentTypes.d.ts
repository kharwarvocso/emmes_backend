...
export interface ApiOurBrandOurBrand extends Struct.CollectionTypeSchema {
  collectionName: 'our_brands';
  info: {
    displayName: 'our brand';
    pluralName: 'our-brands';
    singularName: 'our-brand';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero_section: Schema.Attribute.DynamicZone<
      [
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::our-brand.our-brand': ApiOurBrandOurBrand;
